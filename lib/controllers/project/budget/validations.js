...
const createProjectBudgetRules = {
  projectId: [
    {
      fn: value => typeof value !== 'undefined',
...
const updateProjectBudgetRules = {
  projectName: createProjectBudgetRules.projectName,
  year: createProjectBudgetRules.year,
  currency: createProjectBudgetRules.currency,
  initialBudgetLocal: createProjectBudgetRules.initialBudgetLocal,
  budgetUsd: createProjectBudgetRules.budgetUsd,
  initialScheduleEstimateMonths:
    createProjectBudgetRules.initialScheduleEstimateMonths,
  adjustedScheduleEstimateMonths:
    createProjectBudgetRules.adjustedScheduleEstimateMonths,
  contingencyRate: createProjectBudgetRules.contingencyRate,
  escalationRate: createProjectBudgetRules.escalationRate,
  finalBudgetUsd: createProjectBudgetRules.finalBudgetUsd
}

module.exports = {
  currencyRules,
  createProjectBudgetRules,
  updateProjectBudgetRules
}
